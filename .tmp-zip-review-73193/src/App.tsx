...
import { AdminBookDocuments } from './pages/admin/BookDocuments';
import { AdminDocumentChunks } from './pages/admin/DocumentChunks';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin/books/:bookId/documents" element={<AdminBookDocuments />} />
        <Route
                path="/admin/books/:bookId/documents/:documentId/chunks"
                element={<AdminDocumentChunks />} />
