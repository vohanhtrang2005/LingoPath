...
import type { BookDocument, DocumentStatus } from '../../types/document';
                ...
                <tr
                  ...
                  selectedId === document.id ? 'bg-cream-100/80' : 'hover:bg-cream-100/60'}`
                    ...
                    <td className="px-3 py-4">
                      ...
                      null}
                        {busy && document.status !== 'EXTRACTING' ?
                      'EXTRACTING' :
                      document.status}
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-4">
                      ...
                      <button
                        ...
                        busy ? 'cursor-not-allowed bg-peach-200' : 'bg-peach-500 hover:bg-peach-400'}`
                        }>
                      ...
                      null}
                        ...
                        extracted ?
                        'View chunks' :
                        'Extract this document before generating chunks.'
                        }
                        ...
                        extracted ?
                        'bg-sky-100 text-[#3b6a94] hover:bg-[#d6e8f6]' :
