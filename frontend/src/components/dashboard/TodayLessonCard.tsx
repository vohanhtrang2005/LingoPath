...
export function TodayLessonCard({
  onStart,
  lesson = todayLesson,
  chapterDone = learner.chapterDone,
  chapterTotal = learner.chapterTotal
}: TodayLessonCardProps) {
  const progress = Math.round(chapterDone / chapterTotal * 100);
        ...
        <div className="mt-8 border-t border-cream-200 pt-5">
          <div className="flex items-baseline justify-between gap-3">
            ...
            <p className="text-xs font-semibold text-ink-soft">
              {chapterDone} of {chapterTotal} lessons
            </p>
          </div>
