  ...
  return (
    <main className="relative min-h-full w-full overflow-hidden px-5 py-8 sm:px-8 sm:py-10">
      ...
      <div className="relative mx-auto w-full max-w-2xl">
        <button
          type="button"
          onClick={() => navigate('/learn/today/grammar')}
        ...
        <motion.header
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded-full bg-peach-500 px-3 py-1 font-display text-xs font-bold text-white">
              Day {grammarLesson.dayIndex} · {grammarLesson.sectionTitle} practice
            </span>
          ...
          <p className="mt-2 text-[15px] leading-relaxed text-ink-soft">
            Every question is checked against the approved records from your book. Mistakes are
            explained, and weak patterns come back sooner in your review schedule.
          </p>
        </motion.header>
